...
funcDefStart
 : SCOPE? (PROCEDURE | FUNCTION) idAttr2 ('(' parameters? ')')? NL parameterDef?
 ;
...
otherCmds
 ...
 | CLEAR (ALL | CLASS expr | CLASSLIB specialExpr | DEBUG | DLLS specialArgs | EVENTS | ERROR | FIELDS | GETS | MACROS | MEMORY | MENUS | POPUPS | PROGRAM | PROMPT | READ ALL? | RESOURCES expr | TYPEAHEAD | WINDOWS)? #clearStmt
